---
title: "Reverse Engineering an IPA (forge analysis)"
...
- [`architecture`](/docs/architecture) — the `machO/objc.py` analysis engine `hooks/` and `analysis/` share
- [`usage`](/docs/usage) — `forge hooks` and the rest of the CLI
