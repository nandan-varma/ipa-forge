...
(see [`patch-reference`](/docs/patch-reference), "The `hooks` block"
section).
...
definition per the [Patch Definition Reference](/docs/patch-reference).
...
- [`adding-an-app`](/docs/adding-an-app) — porting
